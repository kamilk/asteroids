...
namespace Asteroids
{
    struct SpriteCornerVertex
    {
        ...
        (
            ...
            new VertexElement(24, VertexElementFormat.Single, VertexElementUsage.PointSize, 0),
            new VertexElement(28, VertexElementFormat.Single, VertexElementUsage.PointSize, 1)
        );
